...
- [API reference on Swift Package Index](https://swiftpackageindex.com/scenee/FloatingPanel/3.2.3/documentation/floatingpanel)
...
```swift
.package(url: "https://github.com/scenee/FloatingPanel", from: "3.2.3"),
```
