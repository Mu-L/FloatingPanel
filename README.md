...
FloatingPanel is written in Swift 5.0+ and compatible with iOS 15.0+.

## Documentation

- [API reference on Swift Package Index](https://swiftpackageindex.com/scenee/FloatingPanel/3.2.4/documentation/floatingpanel)
